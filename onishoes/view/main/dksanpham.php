    ...
    <?php  
      ...
      <ul class="pagination justify-content-center">
         <?php for($x=1;$x<=$sotrang;$x++){ ?>
          <li class="page-item">
          	  <a class="page-link" href="/onishoes/index.php?view=dksanpham&madm=<?php echo $madm;?>&t=<?php echo $t ?>&trang=<?php echo $x ?>&sx=<?php echo $sx1 ?>"><?php echo $x ;?></a></li>
          <?php } ?>
...
<?php
          if(isset($_GET['mancc'])){
            ...
            $from =($trang-1)*12;
			  ...
			  $ds_spnb="SELECT * FROM `sanpham` WHERE `MaNCC`=".$mancc." ".$sx1." LIMIT $from,12 ";
...
<div class="container-fluid ">
	<div class="container">
		<div class="row boderbot" >
			<h3 class="col-md-10 ft"> <?php echo mb_strtoupper($t); ?> <?php echo 'co ' .$sosp . ' san pham'?></h3>
			<select name="SortBy" id="SortBy" onchange="validateSelectBox(this)" class="form-control form-control-sm col-2 form-horizontal">
			    <option value="default">Tùy chọn</option>
			    <option <?php if ($sx=='price-ascending') {echo 'selected';}?>
			     value="price-ascending">Giá từ thấp tới cao</option>
...
<!-- Phân trang -->
    ...
    <?php  
      ...
      <ul class="pagination justify-content-center">
         <?php for($x=1;$x<=$sotrang;$x++){ ?>
          <li class="page-item">
          	  <a class="page-link" href="/onishoes/index.php?view=dksanpham&mancc=<?php echo $mancc;?>&t=<?php echo $t ?>&trang=<?php echo $x ?>&sx=<?php echo $sx1 ?>"><?php echo $x ;?></a></li>
          <?php } ?>
      </ul>
		<form action="" method="get" accept-charset="utf-8">
